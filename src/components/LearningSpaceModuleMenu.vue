      ...
      <RouterLink :to="`/space/${uid}/module/${module.id}`" class="d-flex module-item">
        ...
        >
          <mask
            ...
            height="25"
          >
            <rect x="0.493652" y="0.348755" width="24" height="24" fill="#D9D9D9" />
          </mask>
        ...
        >
          <mask
            ...
            height="25"
          >
            <rect y="0.348755" width="24" height="24" fill="#D9D9D9" />
          </mask>
            ...
            >
              <div class="d-block mt-1 mb-1 ms-1">
                ...
                >
                  ...
                  <svg
                    class="lesson-icon ms-1"
                    :class=" { 'no-icon': !lesson.completed }"
                    width="18"
                    height="19"
                    viewBox="0 0 18 19"
                    fill="none"
